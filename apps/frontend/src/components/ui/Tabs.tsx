...
export const Tabs: React.FC<TabsProps> = ({ tabs, activeTab, onChange, onTabChange, showLanguageSelector = false }) => {
  ...
  return (
    <div>
      ...
      <div className="tab-container">
        <nav className="-mb-px flex space-x-8 overflow-x-auto items-center justify-between">
