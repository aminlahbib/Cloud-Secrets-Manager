...
interface TeamsVsDirectGuidanceProps {
  compact?: boolean;
}

export const TeamsVsDirectGuidance: React.FC<TeamsVsDirectGuidanceProps> = ({ compact = false }) => {
    ...
    return (
      <>
        <button
          ...
          title="When to use Teams vs Direct Invitations?"
        >
        ...
        {isOpen && (
          <>
            ...
            />
            <div
              className="fixed z-50 rounded-lg border shadow-xl p-4 max-w-2xl"
              style={{
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <ul className="space-y-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 mt-0.5 flex-shrink-0" style={{ color: 'var(--accent-primary)' }} />
                      <span>Bulk access management</span>
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  <ul className="space-y-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 mt-0.5 flex-shrink-0" style={{ color: 'var(--accent-primary)' }} />
                      <span>Specific roles on individual projects</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 mt-0.5 flex-shrink-0" style={{ color: 'var(--accent-primary)' }} />
