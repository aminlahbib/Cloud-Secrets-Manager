...
1. **Metrics** (Prometheus) - Numerical measurements over time
...
- **Query language (PromQL)**: Powerful querying
...
## Project-Specific: Our Monitoring Setup
...
- **ServiceMonitors**: Auto-discover services to scrape
